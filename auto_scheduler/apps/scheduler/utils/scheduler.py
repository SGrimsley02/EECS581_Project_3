...
def schedule_tasks(
    ...
    for task in tasks_sorted:
        ...
        for chunk_minutes in chunks:
            ...
            if task.get("recurring") and task.get("recurring_until"):
                recurrence_end_date = task["recurring_until"]
                    ...
                    if r_start is None:
                        ...
                        if r_start is None:
                            logger.warning(
                                ...
                                task.get("title"), occurrence_date
                            )
