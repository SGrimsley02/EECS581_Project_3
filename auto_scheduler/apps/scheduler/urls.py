...
from .views import preferences, upload_ics, add_events, view_calendar, auth_view, home, event_feed, dismiss_preferences_recap, event_stats, delete_event, edit_event
